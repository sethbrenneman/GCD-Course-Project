...
subject_test <- read.table("./R Files/UCI HAR Dataset/test/subject_test.txt")
x_test <- read.table("./R Files/UCI HAR Dataset/test/X_test.txt")
y_test <- read.table("./R Files/UCI HAR Dataset/test/y_test.txt")
test <- cbind( x_test, subject_test, y_test)

subject_train <- read.table("./R Files/UCI HAR Dataset/train/subject_train.txt")
x_train <- read.table("./R Files/UCI HAR Dataset/train/x_train.txt")
y_train <- read.table("./R Files/UCI HAR Dataset/train/y_train.txt")
...
features <- read.table("./R Files/UCI HAR Dataset/features.txt")
